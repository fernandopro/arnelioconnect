//  CSS
import "../scss/scfs_arnelioconnect_dashboard.scss";
...
const post_id = null;
const php_options = scfs_arnelioconnect_dashboard.php_options;
const security = scfs_arnelioconnect_dashboard.security;
const ajax_url = scfs_arnelioconnect_dashboard.ajax_url;
const id_form = scfs_arnelioconnect_dashboard.id_form;
const auto_save_click = scfs_arnelioconnect_dashboard.auto_save_click;
const auto_save_change = scfs_arnelioconnect_dashboard.auto_save_change;
const name_field_options = scfs_arnelioconnect_dashboard.name_field_options;
const field_buttons = scfs_arnelioconnect_dashboard.field_buttons;
const field_buttons_multi = scfs_arnelioconnect_dashboard.field_buttons_multi;
const dateTransientAdmin = scfs_arnelioconnect_dashboard.dateTransientAdmin;
const compareTimeField = scfs_arnelioconnect_dashboard.compareTimeField;
