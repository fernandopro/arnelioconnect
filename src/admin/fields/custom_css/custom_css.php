<?php
        ...
        /**
         * Renderiza un campo de custom css personalizado en el panel de administración de WordPress.
         *
         ...
         * @return void
         */
         function scfs_arnelioconnect_custom_css_field($arg)
        {
...
?>
            <div class="layo-field<?php echo $css ?>">
                ...
                <div class="field-arnelio-custom-css">
                    <textarea class="form-control" id="scfs_codemirror_css" aria-describedby="<?php echo esc_attr($name_sanitized); ?>-help" name="<?php echo esc_attr($name_option); ?>[<?php echo esc_attr($name_sanitized); ?>]"><?php echo esc_textarea($current_value); ?></textarea>
                    <?php if (isset($info)): ?>
