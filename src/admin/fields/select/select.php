...
function scfs_arnelioconnect_select_field($arg)
{
    ...
    // Obtener el valor actual del campo select
...
?>
    <div class="layo-field<?php echo $css?>">
        ...
        <div class="field-arnelio-select">
            <select
                ...
                <?php foreach ($initial[$name] as $index => $value): ?>
                    <option
                        ...
                        <?php selected($current_value, $index); ?>>
