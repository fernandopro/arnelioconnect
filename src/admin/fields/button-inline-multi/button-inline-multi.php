<?php
/**
 * Renderiza un campo de botones de checkbox múltiples en el panel de administración de WordPress.
 *
 ...
 * @return void
 */
function scfs_arnelioconnect_button_inline_m_field($arg)
{
...
?>
    <div class="layo-field<?php echo $css?>">
        ...
        <div class="field-arnelio-checkbox-btn-multi">
            <?php foreach ($initial[$name] as $index => $value):
                ...
                $active_class = in_array($index, $current_values, true) ? ' active' : '';
            ?>
                <div class="form-check form-check-inline">
                    ...
                    <label class="btn btn-outline-primary<?php echo $active_class; ?>" for="<?php echo esc_attr($checkbox_id); ?>">
