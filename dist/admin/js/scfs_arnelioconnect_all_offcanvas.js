...
"use strict";
/*!*********************************************************!*\
  !*** ./src/admin/js/scfs_arnelioconnect_all_offcanvas.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var core_js_modules_es_array_unshift_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! core-js/modules/es.array.unshift.js */ "./node_modules/core-js/modules/es.array.unshift.js");
/* harmony import */ var core_js_modules_es_array_unshift_js__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_unshift_js__WEBPACK_IMPORTED_MODULE_17__);
...
/* harmony import */ var core_js_modules_es_string_link_js__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! core-js/modules/es.string.link.js */ "./node_modules/core-js/modules/es.string.link.js");
/* harmony import */ var core_js_modules_es_string_link_js__WEBPACK_IMPORTED_MODULE_33___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_link_js__WEBPACK_IMPORTED_MODULE_33__);
...
/* harmony import */ var bootstrap_js_dist_tab__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! bootstrap/js/dist/tab */ "./node_modules/bootstrap/js/dist/tab.js");
/* harmony import */ var bootstrap_js_dist_tab__WEBPACK_IMPORTED_MODULE_38___default = /*#__PURE__*/__webpack_require__.n(bootstrap_js_dist_tab__WEBPACK_IMPORTED_MODULE_38__);
/* harmony import */ var bootstrap_js_dist_alert__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! bootstrap/js/dist/alert */ "./node_modules/bootstrap/js/dist/alert.js");
/* harmony import */ var bootstrap_js_dist_alert__WEBPACK_IMPORTED_MODULE_39___default = /*#__PURE__*/__webpack_require__.n(bootstrap_js_dist_alert__WEBPACK_IMPORTED_MODULE_39__);
/* harmony import */ var bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! bootstrap/js/dist/tooltip */ "./node_modules/bootstrap/js/dist/tooltip.js");
/* harmony import */ var bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_40___default = /*#__PURE__*/__webpack_require__.n(bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_40__);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_41___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_41__);
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   */
  var activateTab = function activateTab(hash) {
    var triggerEl = document.querySelector(".nav-link[href=\"".concat(hash, "\"]"));
    if (triggerEl) {
      var tab = new (bootstrap_js_dist_tab__WEBPACK_IMPORTED_MODULE_38___default())(triggerEl);
      tab.show();

      // Si el enlace está dentro de un dropdown, activamos el dropdown padre
      var dropdownMenu = triggerEl.closest(".dropdown-menu");
      if (dropdownMenu) {
  ...
  var navArnelioCurrent = document.getElementById("nav-arnelio-current");

  // Escuchar cambios en el hash
  window.addEventListener("hashchange", function () {
    var newHash = window.location.hash.replace("#", ""); // Eliminar el '#' al principio del string

    // Agregamos la condición para evitar actualizar si newHash está vacío
    if (newHash !== "") {
      navArnelioCurrent.value = newHash;
    }
    activateTab("#".concat(newHash));
  });

  // Seleccionar el navbar-toggler (Mobile)
  var navbarToggler = document.querySelector(".navbar-toggler");
  var arnelioconnectNavbar = document.getElementById("arnelioconnectNavbar");
  if (navbarToggler) {
  ...
  if (notificationApiButton) {
    notificationApiButton.addEventListener("click", function () {
      // Verificar que container no sea nulo
      if (container && container.innerHTML === "") {
        if (all_js.posts.length > 0) {
          var html = "";
          all_js.posts.forEach(function (post) {
            var title = post.title;
            var link = post.link;
            var relativeDate = post.relative_time;
            // Construir el HTML utilizando clases de Bootstrap
            html += "\n                    <div class=\"post-item-content\">\n                        <div class=\"post-item-icon\">\n                      <i class=\"bi bi-bookmarks-fill\"></i>\n                        </div>\n                        <div class=\"post-item mb-4\">\n                                <div class=\"title-data\">\n                                <a class=\"link-secondary title-data_link\" href=\"".concat(link, "\" target=\"_blank\">").concat(title, "</a>\n                                <span class=\"title-data_date text-body-secondary\">").concat(relativeDate, "</span>\n                                </div>\n                                <div class=\"post-item_body text-body-secondary\">\n                                    <p>").concat(post.excerpt, "</p>\n                                </div>\n                                <a href=\"").concat(link, "\" target=\"_blank\" class=\"btn btn-outline-secondary\">").concat(all_js.messages.m2, "</a>\n                            </div>\n                    </div>\n                        ");
          });
  ...
  var alertPlaceholder = document.getElementById("arnelioconnect-alert-placeholder");
  var notificationUpdateButton = document.getElementById("notification-update");
  var notificationUpdateIcon = document.getElementById("notification-update-icon");
  var notificationUpdateLoader = document.getElementById("notification-update-loader");
  var tooltipTriggerList = document.querySelectorAll('[data-bs-toggle="tooltip"]');
  var tooltipList = _toConsumableArray(tooltipTriggerList).map(function (tooltipTriggerEl) {
    return new (bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_40___default())(tooltipTriggerEl);
  });
  ...
  if (notificationUpdateButton && notificationUpdateLoader) {
    notificationUpdateButton.addEventListener("click", function () {
      ...
      var ajaxRequest = fetch(all_js.ajaxurl, {
        method: "POST",
        headers: {
      ...
      Promise.all([ajaxRequest, minTime]).then(function (_ref) {
        ...
        if (data.success) {
          ...
          unreadPosts.push.apply(unreadPosts, _toConsumableArray(data.data.unread));
          readPosts.push.apply(readPosts, _toConsumableArray(data.data.read));
  ...
  var unreadPosts = all_js.posts.unread || [];
  var readPosts = all_js.posts.read || [];

  // Función para renderizar los posts no leídos
  var renderUnreadPosts = function renderUnreadPosts() {
    if (unreadPosts.length > 0) {
      var htmlUnread = "";
      unreadPosts.forEach(function (post, index) {
        htmlUnread += "\n          <div class=\"post-item-content\" data-post-index=\"".concat(index, "\">\n            <div class=\"post-item-icon\">\n              <i class=\"bi bi-bookmarks-fill\"></i>\n            </div>\n            <div class=\"post-item mb-4\">\n              <div class=\"title-data\">\n                <a class=\"link-secondary title-data_link\" data-post-index=\"").concat(index, "\" href=\"").concat(post.link, "\">").concat(post.title, "</a>\n                <span class=\"title-data_date text-body-secondary\">").concat(post.relative_time, "</span>\n              </div>\n              <div class=\"post-item_body text-body-secondary\">\n                <p>").concat(post.excerpt, "</p>\n              </div>\n              <a href=\"").concat(post.link, "\" class=\"btn btn-outline-secondary read-post\" data-post-index=\"").concat(index, "\">").concat(all_js.messages.m2, "</a>\n            </div>\n          </div>\n        ");
      });
  ...
  var renderReadPosts = function renderReadPosts() {
    if (readPosts.length > 0) {
      var htmlRead = "";
      readPosts.forEach(function (post) {
        htmlRead += "\n          <div class=\"post-item-content\">\n            <div class=\"post-item-icon\">\n              <i style=\"opacity:0.7\" class=\"bi bi-bookmarks-fill\"></i>\n            </div>\n            <div class=\"post-item mb-4\">\n              <div class=\"title-data\">\n                <div class=\"link-secondary title-data_link read\">".concat(post.title, "</div>\n              </div>\n              <div class=\"post-item_body text-body-secondary\">\n                <p>").concat(post.excerpt, "</p>\n              </div>\n              <a href=\"").concat(post.link, "\" target=\"_blank\" class=\"btn btn-outline-secondary\">").concat(all_js.messages.m2, "</a>\n            </div>\n          </div>\n        ");
      });
  ...
  document.addEventListener("click", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var index, selectedPost, formData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            index = e.target.getAttribute("data-post-index");
            selectedPost = unreadPosts[index];
            if (selectedPost) {
              _context.next = 6;
              break;
            }
   ...
   */
  var showBootstrapAlert = function showBootstrapAlert(message, type) {
    if (alertPlaceholder) {
      var wrapper = document.createElement("div");
      wrapper.innerHTML = "\n                <div class=\"alert alert-".concat(type, " alert-dismissible fade show mt-3\" role=\"alert\">\n                    ").concat(message, "\n                    <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button>\n                </div>\n            ");
      alertPlaceholder.append(wrapper);

      // Inicializar el componente de alerta de Bootstrap
      var alertElement = wrapper.querySelector(".alert");
      var bsAlert = new (bootstrap_js_dist_alert__WEBPACK_IMPORTED_MODULE_39___default())(alertElement);
  ...
  var markAllAsRead = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var result, postsToMark, _iterator, _step, post, formData;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return sweetalert2__WEBPACK_IMPORTED_MODULE_41___default().fire({
          ...
          case 2:
            ...
            _context2.prev = 4;
            postsToMark = _toConsumableArray(unreadPosts); // Procesar cada post no leído
            _iterator = _createForOfIteratorHelper(postsToMark);
            _context2.prev = 7;
            _iterator.s();
          case 9:
          ...
          case 27:
            ...
            readPosts.unshift.apply(readPosts, _toConsumableArray(unreadPosts));
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_41___default().fire({
  ...
  if (offcanvas_dismiss) {
    offcanvas_dismiss.addEventListener("click", /*#__PURE__*/function () {
...
/******/ })()
;
//# sourceMappingURL=scfs_arnelioconnect_all_offcanvas.js.map